...
jQuery(document).ready(function(){
    ...
    for(var i = 0; i < listOfDesserts.length; i++){
    ...
    // Use the jQuery each function to loop through part of the object theSchedule and add the days to the right day boxes
